  ...
  return (
    <>
      <div className="relative min-h-screen flex items-center justify-center overflow-hidden">
        ...
        >
          <h1 className="flex items-center gap-2 text-2xl font-bold text-[#F7B205] mb-2">
            <Link to="/">Sakoo</Link>
          </h1>
          ...
          <form>
            ...
            <input
              ...
              required
              className="w-full p-3 mb-1 border border-gray-300 rounded-full focus:outline-none focus:ring-2 focus:ring-[#0E4B40]"
            />
            ...
            <motion.button
              ...
              transition={{ type: "spring", stiffness: 50 }}
              type="submit"
              className="w-full bg-[#0E8F68] hover:bg-[#0c7b5c] text-white p-3 rounded-full font-semibold cursor-pointer"
            >
              Masuk
            </motion.button>
          </form>
